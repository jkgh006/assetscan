...
SYSLOG_NAME = format(time.strftime("%y-%m-%d_%H_%M_%S", time.localtime()))+".log"
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'filename': os.path.join(os.environ.get('LOG_HOME', ''),
                                     os.environ.get('LOG_FILE_NAME', os.path.join(LOGGERPATH, SYSLOG_NAME))),
            'formatter': 'verbose',
            'encoding': 'utf8'
