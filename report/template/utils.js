function e(e, t, n) {
    ...
    "function" == typeof i ? i = new i(t, {
        detail: n
    }) : ((i = r.createEvent("Event")).initEvent(t, !1, !1),
        i.detail = n),
        e.dispatchEvent(i)
}
function t(e) {
...
function w(n, i, o, a) {
    let s, l, u, c, d = t(n);
    n instanceof Map ? (s = `Map(${n.size})`,
        l = g) : n instanceof Set ? (s = `Set(${n.size})`,
        l = y) : d ? (s = `${n.constructor.name}(${n.length})`,
        l = E) : (c = m(n)) ? (s = `Immutable.${c.name}${"Record" === c.name ? "" : `(${n.size})`}`,
        d = c.arrayish,
        l = c.arrayish ? C : c.setish ? x : P) : a ? (s = f(n),
        l = N) : (s = f(n),
        l = S);
...
function k(e, n, i, o) {
    let a, s, l, u, c = t(e);
    if (e instanceof Map ? (a = `Map(${e.size})`,
        s = T) : e instanceof Set ? (a = `Set(${e.size})`,
        s = A) : c ? (a = `${e.constructor.name}(${e.length})`,
        s = R) : (u = m(e)) ? (a = `Immutable.${u.name}${"Record" === u.name ? "" : `(${e.size})`}`,
        c = u.arrayish,
        s = u.arrayish ? U : u.setish ? O : F) : (a = f(e),
        s = D),
        n) {
        const t = document.createElement("span");
...
class ue {
    ...
    fulfilled(t, n) {
        const {_node: r} = this;
        if ((!(t instanceof Element || t instanceof Text) || t.parentNode && t.parentNode !== r) && (t = ae(t, !1, r.firstChild && r.firstChild.classList && r.firstChild.classList.contains("observablehq--expanded"), n)).classList.add("observablehq--inspect"),
    ...
    rejected(t, n) {
        const {_node: i} = this;
        for (i.classList.remove("observablehq--running"),
                 i.classList.add("observablehq--error"); i.lastChild;)
...
function Ee(e) {
    const t = `${be}${e.name}${e.version ? `@${e.version}` : ""}/package.json`;
    let n = fe.get(t);
...
var Ce = Ne(async function (e, t) {
    if (e.startsWith(be) && (e = e.substring(be.length)),
        /^(\w+:)|\/\//i.test(e))
        return e;
    if (/^[.]{0,2}\//i.test(e))
    ...
    if (n.path && !ge.test(n.path) && (n.path += ".js"),
    n.path && n.version && we.test(n.version))
        return `${be}${n.name}@${n.version}/${n.path}`;
    const r = await Ee(n);
    return `${be}${r.name}@${r.version}/${n.path || function (e) {
        for (const t of ye) {
            const n = e[t];
            if ("string" == typeof n)
...
function Ne(e) {
    ...
    return o.alias = function (t) {
        return Ne((n, r) => n in t && (r = null,
        "string" != typeof (n = t[n])) ? n : e(n, r))
    }
        ,
        o.resolve = e,
        o
...
function Me(e, t, n) {
    ...
    r < 2 ? (n = e,
        ...
        he.push(me.call(t, qe) ? e => {
                ...
                return Promise.all(pe.call(t, t => "exports" === (t += "") ? r : "module" === t ? i : e(t))).then(e => (n.apply(null, e),
                    i.exports))
            }
    ...
    return {
        ...
        next: function () {
            return {
                ...
                value: r ? (r = !1,
                    Promise.resolve(t)) : new Promise(e => n = e)
            }
        }
    }
}
...
function Ie(e, t) {
    return function (n) {
        var r, i, o, a, s, l, u, c, d = n[0], f = [], h = null, p = -1;
        for (s = 1,
                 l = arguments.length; s < l; ++s) {
            if ((r = arguments[s]) instanceof Node)
                ...
                for (u = 0,
                         c = r.length; u < c; ++u)
                    (i = r[u]) instanceof Node ? (null === h && (f[++p] = h = document.createDocumentFragment(),
                        d += "\x3c!--o:" + p + "--\x3e"),
                        h.appendChild(i)) : (h = null,
                        d += i);
                h = null
            } else
                d += r;
        ...
        ++p > 0) {
            for (o = new Array(p),
                     a = document.createTreeWalker(h, NodeFilter.SHOW_COMMENT, null, !1); a.nextNode();)
                i = a.currentNode,
                /^o:/.test(i.nodeValue) && (o[+i.nodeValue.slice(2)] = i);
            for (s = 0; s < p; ++s)
                (i = o[s]) && i.parentNode.replaceChild(f[s], i)
        }
        return 1 === h.childNodes.length ? h.removeChild(h.firstChild) : 11 === h.nodeType ? ((i = t()).appendChild(h),
            i) : h
    }
}
...
function gt(e, t, n) {
    ...
    if (this._inputs.forEach(bt, this),
        t.forEach(vt, this),
        this._inputs = t,
        this._definition = n,
        this._value = void 0,
    ...
    e == this._name && r.get(e) === this)
        ...
        if (this._name)
            if (this._outputs.size)
                ...
                1 === a._duplicates.size && (a = a._duplicates.keys().next().value,
                    o = r.get(this._name),
        ...
        if (this._outputs.size)
            throw new Error;
        e && ((a = r.get(e)) ? a._type === ht ? (this._definition = wt(e),
            this._duplicate = n,
            a._duplicates.add(this)) : a._type === ft ? (this._outputs = a._outputs,
            a._outputs = new Set,
            this._outputs.forEach(function (e) {
                e._inputs[e._inputs.indexOf(a)] = this
            }, this),
            i._dirty.add(a).add(this),
            r.set(e, this)) : (a._duplicate = a._definition,
            this._duplicate = n,
            (o = new mt(ht, this._module))._name = e,
            o._definition = this._definition = a._definition = wt(e),
...
function yt(e, t = []) {
    Object.defineProperties(this, {
        ...
        _builtins: {
            value: new Map([["invalidation", Ct], ["visibility", Nt], ...t])
        },
        _source: {
            value: null,
            writable: !0
    ...
    Object.defineProperties(yt.prototype, {
        ...
        value: {
            value: async function (e) {
                ...
                if (!t)
                    throw new it(e + " is not defined");
                t._observer === pt && (t._observer = !0,
                    this._runtime._dirty.add(t));
...
var Ct = {}
    , Nt = {};
function St(e = new rt, t = function (e) {
    return window[e]
}) {
    var n = this.module();
...
function jt(e, t) {
    let n, r, i = "function" == typeof IntersectionObserver && t._observer && t._observer._node, o = !i, a = ct, s = ct;
    return i && ((r = new IntersectionObserver(([e]) => (o = e.isIntersecting) && (n = null,
        a()))).observe(i),
        e.then(() => (r.disconnect(),
            r = null,
            s()))),
        function (e) {
            return o ? Promise.resolve(e) : r ? (n || (n = new Promise((e, t) => (a = e,
                s = t))),
                n.then(() => e)) : Promise.reject()
        }
}
function kt(e) {
    e._invalidate(),
    ...
    var t = e._value
        ...
        }(t) ? e._version !== n ? void t.return() : ((r || Lt(e)).then((o = t,
                function () {
                    o.return()
                }
        )),
    ...
    i.then(function (t) {
        e._version === n && (e._value = t,
            e._fulfilled(t))
    }, function (t) {
        e._version === n && (e._value = void 0,
            e._rejected(t))
    })
}
function Tt(e, t, n) {
            ...
            value: function () {
                ...
                (e = new Set(this._dirty)).forEach(function (t) {
                    ...
                    (e = new Set(this._updates)).forEach(function (t) {
                        t._reachable ? (t._indegree = 0,
                            t._outputs.forEach(e.add, e)) : (t._indegree = NaN,
                            e.delete(t))
                    }),
                ...
                do {
                    ...
                    e.forEach(function (t) {
                        Pt(t) && (At(t, new it("circular definition")),
                            t._outputs.forEach(Mt),
                            e.delete(t))
                    })
                } while (e.size);
                function r(e) {
